...
def infoset1_result1_entcodes(entCodes, bPrompt=False, numEntries=-1, entDB=None):
    """
...
def infoset1_result2_entcodes(entCodes, numEntries=20, entDB=None):
    entDB = _entDB(entDB)
    print("INFO:InfoSet1Result2: Top {} entities for the last day".format(numEntries))
    t1 = anal_simple('roabsMetaData', 'normal', 'top', theIndex=0, numEntities=numEntries)
    print("INFO:InfoSet1Result2: Bottom {} entities for the last day".format(numEntries))
    b1 = anal_simple('roabsMetaData', 'normal', 'bottom', theIndex=0, numEntities=numEntries)
    print("INFO:InfoSet1Result2: Top {} entities wrt last 7 days".format(numEntries))
    t1 = anal_simple('roabsMetaData', 'normal', 'top', theIndex=1, numEntities=numEntries)
    print("INFO:InfoSet1Result2: Bottom {} entities wrt last 7 days".format(numEntries))
    b1 = anal_simple('roabsMetaData', 'normal', 'bottom', theIndex=1, numEntities=numEntries)
...
def infoset1_result(entTypeTmpls=[], entNameTmpls=[], bPrompt=False, numEntries=20, entDB=None):
    ...
    infoset1_result1_entcodes(entCodes, bPrompt, numEntries, entDB=entDB)
